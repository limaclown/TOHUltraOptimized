...
public class OptionBackupData
{
    ...
    public OptionBackupData(IGameOptions option)
    {
        ...
        foreach (RoleTypes role in new RoleTypes[] { RoleTypes.Scientist, RoleTypes.Engineer, RoleTypes.GuardianAngel, RoleTypes.Shapeshifter, RoleTypes.Noisemaker, RoleTypes.Judge, RoleTypes.Phantom, RoleTypes.Tracker })
        {
