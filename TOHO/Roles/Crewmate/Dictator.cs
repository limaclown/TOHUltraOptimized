        ...
        if (operate == 2)
        {
            ...
            if (AntiBlackout.BlackOutIsActive)
            {
                if (isBlackOut)
                    ...
                    MeetingHud.Instance.RpcVotingComplete(statesList.ToArray(), exiled, false, false, byte.MaxValue);
                if (exiled != null)
                {
            ...
            {
                MeetingHud.Instance.RpcVotingComplete(states, exiled, false, false, byte.MaxValue);
